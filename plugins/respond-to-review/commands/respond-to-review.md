...
7. Parse the diff to build a map of changed files and their hunk ranges (`file path → list of [newStart, newStart+newCount-1]` ranges), and whether each line is added (`+`) or context (` `).
