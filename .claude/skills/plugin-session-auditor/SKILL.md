...
- User says one of the plugins (`git`, `code-review`, `respond-to-review`, `test-driven-fix`, `docs`, `debate`, `simplify`, `transcript`, `jira`, `tool-discipline`, `tool-discipline-lsp`) misbehaved in a recent session.
