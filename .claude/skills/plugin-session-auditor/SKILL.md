...
- User says one of the plugins (`cherry-pick`, `merge`, `code-review`, `code-review-AT`, `respond-to-review`, `test-driven-fix`, `doc-audit`, `debate`) misbehaved in a recent session.
