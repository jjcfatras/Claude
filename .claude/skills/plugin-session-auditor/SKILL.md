...
- User says one of the plugins (`git`, `code-review`, `code-review-AT`, `respond-to-review`, `test-driven-fix`, `docs`, `debate`, `simplify`, `transcript`, `jira`) misbehaved in a recent session.
