...
- User says one of the plugins (`git`, `code-review`, `code-review-AT`, `respond-to-review`, `test-driven-fix`, `docs`, `debate`, `simplify`, `transcript`, `jira-ticket`, `jira-implement`) misbehaved in a recent session.
