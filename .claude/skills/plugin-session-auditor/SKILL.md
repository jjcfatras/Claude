...
- User says one of the plugins (`cherry-pick`, `merge`, `code-review`, `code-review-AT`, `respond-to-review`, `test-driven-fix`, `doc-audit`, `debate`, `simplify`, `transcript`, `jira-ticket`) misbehaved in a recent session.
