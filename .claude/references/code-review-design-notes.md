...
Maintainer-only context for `~/.claude/commands/code-review.md` and `~/.claude/agents/code-review-*.md`. Not read by the skill at runtime. Capture rationale here so the runtime prompts stay terse.
