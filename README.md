...
| `code-review`       | `/code-review [pr-number]`                                                                                                   | Multi-specialist PR review (security, quality, errors, perf, plus conditional typescript, react, infra, claude-md) using parallel native Claude Code subagents. Posts inline comments. Ships as a skill, so Claude can auto-invoke it in addition to the `/` command.                                                                                                                                                                        |
